...
### Added
- Linux binary support (Ubuntu/Debian)
- Startup disclaimer dialog requiring acceptance before use
- Enhanced About dialog with version info, author contact, and GitHub repository link

### Changed
- Renamed "Help" button to "About" with improved information display
